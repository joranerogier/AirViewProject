...
model="NSL-LUR-drift100m-airview-lte40-mt10dd"                    # Dispersion model
...
file_airview <- "AMS_DataMixed_NO2_5Jul_MidPoints_10plusDrivingDays_lte40_.csv"#
...
vario_res_drift=vario.calc(data2.db)#, lag=25, nlag=12) # experimental variogram on residuals
...
#unique.neigh=neigh.create(ndim=2,type=2, nmini=2, nmaxi = 10, radius=100)# TODO: check this -> orginally this:neigh.create(type=0,ndim=2)
