...
file_airview <- "AMS_fishnet_100m_summarize_weighted_conc_LTE50_points.csv"#
...
vario_res_drift=vario.calc(data2.db, lag=100) # experimental variogram on residuals
...
write.table(grid,file=paste(outdir2,"EDK_grid_100m_weighted_airview_dd_100m_",city,"_",pol,"_",estim_YYYY,"_",kriging_data,'.csv',sep=''),row.names=F,col.names=T,sep=';')
