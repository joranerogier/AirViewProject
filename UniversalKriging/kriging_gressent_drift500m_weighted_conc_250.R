...
res_airview = 250 # to compute the VME. 
...
unique.neigh=neigh.create(ndim=2,type=2, nmini=5, nmaxi = 50, radius=c(700,700))# TODO: check this -> orginally this:neigh.create(type=0,ndim=2)
