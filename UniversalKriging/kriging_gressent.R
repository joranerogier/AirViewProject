...
indir_airview <- "C:/Users/Jorane Rogier/Documents/Master/DSthesis/Data/intersection/"#GoogleAir/Amsterdam/"#
file_drift <- "fishnet_AMS_NSL_500m_SummarizeWithin_NSL_LUR_predictions_.shp"                                                            # Drift file
file_airview <- "AMS_airview_raw_gt7res_nsl_within50m_version3.csv"#"AMS_DataMixed_NO2_5Jul_MidPoints_10plusDrivingDays.csv"#
...
airview_ams <-read_csv(file=paste0(indir_airview, file_airview))
...
plot(data_plt,pch=21,col='black',bg=col_pol,add=T,cex=0.5)# plot target variable
dev.off()
