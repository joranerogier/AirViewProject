...
drift_points_df <- subset(drift_points_df, select=-c(Point_Count,  OID_,ORIG_FID))
...
grid.db=db.create(grid2[,c("lon","lat","Drift")],flag.grid=F,autoname=F)# grid is also in RDnew
