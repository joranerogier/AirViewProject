...
vario_res_drift=vario.calc(data2.db)#, lag=200, nlag=12) # experimental variogram on residuals
...
write.table(grid,file=paste(outdir2,"EDK_grid_drift500mNSLLURmin10DrivingDays_autolag_uniqueneigh",city,"_",pol,"_",estim_YYYY,"_",kriging_data,'.csv',sep=''),row.names=F,col.names=T,sep=';')
