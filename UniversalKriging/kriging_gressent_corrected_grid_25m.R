...
# Directory paths
indir_drift <- "C:/Users/Jorane Rogier/Documents/Master/DSthesis/Data/GridData/AMS_grid_25m_NSL_corrected_resgt20_times2point5_LUR_predictions/"
...
file_drift <- "AMS_grid_25m_NSL_corrected_resgt20_times2point5_LUR_predictions.shp"                                                            # Drift file
file_drift_points <- "AMS_grid_25m_NSL_corrected_resgt20_times2point5_LUR_predictions_points.csv"
...
write.table(grid,file=paste(outdir2,"EDK_grid_corrected_grid_25m_",city,"_",pol,"_",estim_YYYY,"_",kriging_data,'.csv',sep=''),row.names=F,col.names=T,sep=';')
