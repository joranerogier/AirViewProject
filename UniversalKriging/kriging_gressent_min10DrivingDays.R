...
vario_res_drift=vario.calc(data2.db, lag=100, nlag=15) # experimental variogram on residuals
...
write.csv(prediction_df, paste0(outdir2, "predictions_gressent_drift500m_airview_mte10dd_autoVarioCalc_allneighbours.csv"))
